...
#Install script for Yaru-Mate Theme by Jannomag
...
echo -e "${BGre}Y88b   d88P                           888b     d888        888"            
echo -e " Y88b d88P                            8888b   d8888        888"           
echo -e "  Y88o88P                             88888b.d88888        888"          
echo -e "   Y888P  8888b. 888d888888  888      888Y88888P888 8888b. 888888 .d88b."  
echo -e "    888      \"88b888P\"  888  888      888 Y888P 888    \"88b888   d8P  Y8b" 
echo -e "    888  .d888888888    888  888888888888  Y8P  888.d888888888   88888888" 
echo -e "    888  888  888888    Y88b 888      888   \"   888888  888Y88b. Y8b."     
echo -e "    888  \"Y888888888     \"Y88888      888       888\"Y888888 \"Y888 \"Y8888"  
echo -e "${RCol}"                                                                        
...
echo -e ""
echo -e "${BWhi}Do you want to install the GTK Theme Yaru-Mate?${RCol}"
...
do
  case $gtkinstall in
	...
	cp -R ./gtk/Yaru-Mate $gtkpath
	cp -R ./gtk/Yaru-Mate-dark $gtkpath
...
if [ -d "$gtkpath/Yaru-Mate" ] && [ -d "$gtkpath/Yaru-Mate-dark" ]
  then
...
if [ -d "/usr/share/gnome-shell/theme/Yaru" ]
  then 
      ...
      case $origshell in
         yes)
             ...
             if [ -d "/usr/share/gnome-shell/theme/Yaru-BACKUP" ]
               then
                 echo -e "${Yel}Copying Yaru-Mate files...${RCol}"
	       ...
	       ;;
         no)
             echo -e "${Yel}Okay, Yaru-Mate shell theme will be installed into \n$gtkpath/Yaru-Mate${RCol}"
             cp -R ./shell $gtkpath/Yaru-Mate/gnome-shell
             sleep 1
             echo -e "${Yel}Done.${RCol}"
             break
             ;;
    ...
    echo -e "${Yel}Okay, Yaru-Mate shell theme will be installed into $gtkpath/Yaru-Mate${RCol}"
    cp -R ./shell $gtkpath/Yaru-Mate/gnome-shell
    sleep 1
    echo -e "${Yel}Done.${RCol}"     
fi
  ...
  do 
	...
	sleep 1
      ...
      no)
        ...
        echo -e "${BWhi}'gsettings set org.gnome.desktop.interface gtk-theme 'Yaru-Mate''${RCol}"
	break
        ;;
      *)
...
select dock in yes no
  do
	...
	sleep 0.5
	echo -e "${BGre}Look there, Mate dots!${RCol}"
	break
	;;
      no)
...
echo -e "${Yel}Do you want to install the Yaru-Mate icons to '/usr/share/icons/'?${RCol}"
select icons in yes no
  do
    case $icons in
      yes)
         echo -e "${Yel}Okay, copying files...${RCol}"
	 cp -R ./icons/Yaru-Mate /usr/share/icons/
	 sleep 1
         if [ -d "/usr/share/icons/Yaru-Mate" ]
	   then
...
\nIf you installed it in '/usr/share/themes/Yaru-Mate' you need to enable the 'Yaru-Mate'
theme.${RCol}" | fold -s
sleep 2
...
echo -e "${BCya}...and thanks for choosing my Yaru-Mate theme!${RCol}"
sleep 1
