...
echo -e "# I JUST MODIFIED THE COLORS AND SOME IMAGES / SVG     #"
echo -e "# THE ORIGINAL CREDITS FOR THIS GREAT WORK GO TO THE   #"
echo -e "# UBUNTU YARU DEVELOPER TEAM!                          #"
echo -e "# ---------------------------------------------------- #"
echo -e "# FEEL FREE TO MODIFY MY WORK                          #"
echo -e "# ---------------------------------------------------- #"
echo -e "# MY E-MAIL FOR SUGGESTIONS:    jannomag@gmail.com     #"
echo -e "# ---------------------------------------------------- #"
echo -e "# THIS THEMES WERE INITIALLY RELEASED IN APRIL 2019    #"
...
# commented out because files are existing and symlinks are not needed anymore
